...
<body>
                    ...
                    <div class="slide">
                        ...
                        <div class="content">
                            <div class="title">
                                ...
                                <h5>Sarà possibile prendere in prestito i vostri libri preferiti in tutta sicurezza</h5>
                                <a href="biblio.php" class="btn">Scopri i nostri libri</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="slide">
                        ...
                        <div class="content">
                            <div class="title">
                                ...
                                <h5>I libri non sono disponibili? Non preoccupatevi, avete la possibilità di prenotare!</h5>
                                <a href="biblio.php" class="btn">Scopri i nostri libri</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="recomended-sec">
        <div class="container">
            <div class="title">
                <h2>I libri pubblicati più recentemente!</h2>
                <hr>
            </div>
            <div class="row">
              <?php
