...
<body>
    ...
    <section class="static about-sec">
        <div class="container">
            ...
            <p>Registrandoti al nostro portale potrai usufruire di numerosi vantaggi. Per esempio potrai effettuare prestiti e prenotazioni dei tuoi libri preferiti! Inoltre avrai la possibilità di dire la tua idea inserendola come recensione!</p>
      ...
      if(!email_reg_exp.test(email.trim())){
        ...
        jqxhr.done(function(ans){
          if(ans=="1"){
            ...
            alert("Qualche problema con l'iscrizione? Non disperarti, ritenta e andrà meglio vedrai!");
