            ...
            <div class="row">
              ...
              <!--  <div class="col-md-6 slider-sec">-->
                ...
                <div class="col-md-6 slider-content">
                    ...
                    <ul>
                        <li>
                            <a class="name">N° Pagine</a><a class="clm">:</a>
                            <?php
                              $tab=$dbconn->query($query);
                              $row=$tab->fetch_array(MYSQLI_NUM);
                              echo("<a class='price final'>&nbsp;&nbsp;{$row[2]}</a>");
                             ?>
                        </li>
                        <li>
                            <a class="name">Anno di pubblicazione</a><a class="clm">:</a>
                            <?php
                              $tab=$dbconn->query($query);
                              $row=$tab->fetch_array(MYSQLI_NUM);
                              echo("<a class='price final'>&nbsp;&nbsp;{$row[3]}</a>");
                             ?>
                        </li>
                        <li>
                            <a class="name">Autore</a><a class="clm">:</a>
                            <?php
                              $tab=$dbconn->query($query);
                              $row=$tab->fetch_array(MYSQLI_NUM);
                              $at=$row[4];
